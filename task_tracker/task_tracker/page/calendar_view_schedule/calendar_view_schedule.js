{% include "task_tracker/task_tracker/page/calendar_view_schedule/jquery.stickytable.js" %}

frappe.pages['calendar-view-schedule'].on_page_load = function (wrapper) {
...
frappe.ImpLinks= Class.extend({
    ...
    frappe.call({
        "method": "task_tracker.task_tracker.page.calendar_view_schedule.calendar_view_schedule.get_imp_link_data",
        args: {
            filters: filters,
          },
        callback: function (r) {
  ...
  bind_events:function(me){
    ...
    $('.assign_task').click(function() {
      ...
      var assign_task = frappe.pages['calendar-view-schedule'].page.fields_dict.assign_task.get_value()
    ...
    $( ".dbclick" ).dblclick(function() {
      ...
      $('[contenteditable=true]').focus(function() {
              ...
              if ($(this).data("initialText") !== $(this).html()) {
                  ...
                  frappe.call({
                    method: "task_tracker.task_tracker.page.calendar_view_schedule.calendar_view_schedule.create_new_task",
                    args: {data:{
                      caliber: caliber,
                      project: project,
                      date: date,
      ...
      if ((assign_task == "Edit Task") && (task_name) && ( task_name !=exceptional_msg)){
        var d = new frappe.ui.Dialog({
          ...
          primary_action: function() {
            ...
            frappe.call({
              method: "task_tracker.task_tracker.page.calendar_view_schedule.calendar_view_schedule.update_task_details",
              args: {
                data: data,
                task: task_name
              },
  ...
  get_dialog_default:function(d,task_name){
    ...
    var val = ''
    frappe.call({
        method: "task_tracker.task_tracker.page.calendar_view_schedule.calendar_view_schedule.get_task_details",
        args: {name: task_name},
        async: false,
        callback: function(r) {
          if(r.message) {
    ...
    $('.assign_task').click(function() {
      ...
      if ((assign_task == "Delete Task") && (task_name) && ( task_name !=exceptional_msg)){
        frappe.confirm(__("Do you really want to delete this task?"), function () {
          frappe.call({
            method: "task_tracker.task_tracker.page.calendar_view_schedule.calendar_view_schedule.delete_task",
            args: {
              "task_name": task_name
            },
            callback: function(r) {
...
function change_next_week(me){
  ...
  var filter_date =  frappe.pages['calendar-view-schedule'].page.fields_dict.date.get_value()
  ...
  frappe.pages['calendar-view-schedule'].page.fields_dict.date.set_value(next_week_date)
